...
def get_network(name, batch_size):
    ...
    if "resnet" in name:
        ...
        from auto_schedule.testing.net.yolo_v1 import get_workload
        data_shape = (3, 448, 448)
        input_shape = (batch_size, *data_shape)
        output_shape = (batch_size, 1470)
        net, params = get_workload(batch_size=batch_size, image_shape=data_shape, dtype=dtype)
    elif name == "overfeat":
        from auto_schedule.testing.net.overfeat import get_workload
...
tuning_option = {
    ...
    'measure_option': autotvm.measure_option(
        ...
        runner=autotvm.LocalRunner(number=10, repeat=1, timeout=4, min_repeat_ms=150),
