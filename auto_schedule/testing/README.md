...
```
2. 在`config/`中添加配置文件，如`config/gemm_config.py`
...
```python
from auto_schedule.testing.ops import gemm as op_gemm
...
from auto_schedule.testing.config.gemm_config import gemm_shapes
